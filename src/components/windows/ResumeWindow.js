...
const STATIC_COMMANDS = {
  ...
  whoami: () => [
    ...
    'AI Intern @ Northwestern Mutual (Summer 2026)',
    'AI/ML researcher across 4 labs',
  ...
  experience: () => [
    ...
    '  Building AI/ML solutions for financial services',
    '',
    '> Research Intern                   2026 -- Present',
    '  SimLab',
    '  Multi-agent LLM systems for adaptive,',
    '  competency-based sim training (healthcare/edu)',
    '',
